                    ...
                    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
                        <div class="kt-container  kt-container--fluid ">
                            <div class="kt-subheader__main">
                                <h3 class="kt-subheader__title">Most Viewed Products</h3>
                                <span class="kt-subheader__separator kt-subheader__separator--v"></span>
                                <div class="kt-subheader__breadcrumbs">
                                    <a href="{{ url('home') }}" class="kt-subheader__breadcrumbs-home"><i
                                            class="flaticon2-shelter"></i></a>
                                    <span class="kt-subheader__breadcrumbs-separator"></span>
                                    <a href="javascript:;" class="kt-subheader__breadcrumbs-link">Most Viewed
                                        Products</a>
                                ...
                                <table class="table table-striped- table-bordered table-hover table-checkable "
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="110">{{ __('Most View Count') }}</th>
                                        ...
                                        @if (count($products))
                                            ...
                                            @foreach ($products as $key => $product)
                                                <tr class="search-body">
                                                    ...
                                                    <td><img src="{!! asset('/uploads/product/thumb/' . $product->image) !!}"
                                                            style="width:70px;height:70px" /></td>
                                                    <td>
                                                        <strong> {!! $product->most_visited_count !!}</strong>
                                                    </td>
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <ul class="kt-nav">
                                                                        <li class="kt-nav__item">
                                                                            <a href="{{ url('en/details/' . $product->id . '/' . $product->slug) }}"
                                                                                class="kt-nav__link" target="_blank">
                                                                                <i
                                                                                    class="kt-nav__link-icon flaticon2-contract"></i>
                                                                                <span
                                                                                    class="kt-nav__link-text">{{ __('adminMessage.view') }}</span>
                                                                            </a>
                                                                        </li>
                                                                        @if (auth()->guard('admin')->user()->can('product-edit'))
                                                                            <li class="kt-nav__item">
                                                                                <a href="{{ url('/gwc/product/' . $product->id . '/edit') }}"
                                                                                    class="kt-nav__link">
                                                                                    <i
                                                                                        class="kt-nav__link-icon flaticon2-contract"></i>
                                                                                    <span
                                                                                        class="kt-nav__link-text">{{ __('adminMessage.edit') }}</span>
                                                                                </a>
                                                                            </li>
                                                                        @endif
                                                                    </ul>
                                            ...
                                            <tr>
                                                <td colspan="8" class="text-center">{{ $products->links() }}</td>
                                            </tr>
                                        @else
                                            <tr>
