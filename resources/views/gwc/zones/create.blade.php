...
<head>
    <meta charset="utf-8" />
    <title>{{__('adminMessage.websiteName')}}|{{__('adminMessage.createzone')}}</title>
                    ...
                    <div class="kt-container  kt-container--fluid ">
                        <div class="kt-subheader__main">
                            ...
                            <div class="kt-subheader__breadcrumbs">
                                ...
                                <a href="javascript:;" class="kt-subheader__breadcrumbs-link">{{__('adminMessage.createzone')}}</a>
                            </div>
                        </div>
                    ...
                    <div class="kt-portlet">
                        <div class="kt-portlet__head kt-portlet__head--lg">
                            <div class="kt-portlet__head-label">
                                ...
                                <h3 class="kt-portlet__head-title">{{__('adminMessage.createzone')}}</h3>
                            </div>
                        ...
                        @if(auth()->guard('admin')->user()->can('zones-create'))
                            ...
                            <form name="tFrm"  id="form_validation"  method="post"
                                  class="kt-form" enctype="multipart/form-data" action="{{route('zones.store')}}">
