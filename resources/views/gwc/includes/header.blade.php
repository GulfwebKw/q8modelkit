...
$adminLogs = App\Http\Controllers\AdminDashboardController::getLogs();
@endphp
										...
										<div class="kt-head kt-head--skin-dark kt-head--fit-x kt-head--fit-b" style="background-image: url({!! url('admin_assets/assets/media/misc/bg-1.jpg') !!})">
											...
											<ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-success kt-notification-item-padding-x" role="tablist">
												<li class="nav-item">
	<a class="nav-link active show" data-toggle="tab" href="#topbar_notifications_unreadcase" role="tab" aria-selected="true">{{__('adminMessage.logs')}}({{count($adminLogs)}})</a>
												</li>
                                                <li class="nav-item">
	<a class="nav-link" data-toggle="tab" href="#topbar_notifications_contacts" role="tab" aria-selected="false">{{__('adminMessage.contactuslisting')}}({{count($unreadcontacts)}})</a>
										...
										<div class="tab-content">
											<div class="tab-pane active show" id="topbar_notifications_unreadcase" role="tabpanel">
                                                ...
                                                @if(!empty($adminLogs) && count($adminLogs)>0)
                                                    ...
                                                    <a href="{{url('gwc/logs')}}" class="kt-notification__item">
														...
														<div class="kt-notification__item-details">
															...
															<div class="kt-notification__item-time">
																{{ \Carbon\Carbon::parse($adminLog->created_at)->diffForHumans() }}
															</div>
														</div>
													</a>
                                                    @endforeach
							...
							<div class="kt-header__topbar-item kt-header__topbar-item--user">
								...
								<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
									...
									<div class="kt-notification">
										<a href="{{url('vendor/editprofile')}}" class="kt-notification__item">
											<div class="kt-notification__item-icon">
												<i class="flaticon2-calendar-3 kt-font-success"></i>
											</div>
											<div class="kt-notification__item-details">
										...
										<a href="{{url('vendor/changepassword')}}" class="kt-notification__item">
											<div class="kt-notification__item-icon">
												<i class="flaticon2-lock kt-font-warning"></i>
											</div>
											<div class="kt-notification__item-details">
