										...
										<div class="form-group row">
                                          ...
                                          <div class="form-group row">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="{{url('gwc/product/deleteImage/'.$editproduct->id)}}" class="btn btn-brand btn-danger pull-right btn-icon-sm btn-sm "><i class="la la-trash"></i>{{__('adminMessage.delete')}}</a>
                                                @endif
                                                ...
                                                <div class="col-lg-4">
                                                        ...
                                                        <a href="{{url('gwc/product/deleteRolloverImage/'.$editproduct->id)}}" class="btn btn-brand btn-danger pull-right btn-icon-sm btn-sm "><i class="la la-trash"></i>{{__('adminMessage.delete')}}</a>
                                                        @endif
                                                ...
                                                <div class="col-lg-4">
                                                        ...
                                                        <a href="{{url('gwc/product/deletePdf/'.$editproduct->id)}}" class="btn btn-brand btn-danger pull-right btn-icon-sm btn-sm "><i class="la la-trash"></i>{{__('adminMessage.delete')}}</a>
                                                        @endif
                                      ...
                                      <!-- product categories end -->
                                       ...
                                       <div class="kt-portlet__body">
                                            <div class="form-group row">{!!__('adminMessage.browse_images')!!}</div>
                                                ...
                                                <a href="{{url('gwc/product/'.$editproduct->id.'/deletegallery/'.$listGallery->id)}}" class="btn btn-danger btn-sm">Delete</a>
                                                </div>
                                                @endif
                                                @endforeach
                                                @endif
                                       ...
                                       <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                            ...
                                            <div class="form-group row">
                                             ...
                                             <div class="form-group row"><div class="col-lg-12 alert" style="background-color:#DDEEFF;">{!!trans('adminMessage.seo_details_note')!!}</div></div>   
                                                ...
                                                <textarea name="seodescription_en" class="form-control @if($errors->has('seodescription_en')) is-invalid @endif" placeholder="{{__('adminMessage.enterseodescription_en')}}" autocomplete="off">@if(!empty($editproduct->details_en)){{strip_tags(html_entity_decode(preg_replace('/\s\s+/', ' ', $editproduct->details_en)))}}@else{{$editproduct->seodescription_en?$editproduct->seodescription_en:old('seodescription_en')}}@endif</textarea>
                                                ...
                                                <textarea name="seodescription_ar" class="form-control @if($errors->has('seodescription_ar')) is-invalid @endif" placeholder="{{__('adminMessage.enterseodescription_ar')}}" autocomplete="off">@if(!empty($editproduct->details_ar)){{strip_tags(html_entity_decode(preg_replace('/\s\s+/', ' ', $editproduct->details_ar)))}}@else{{$editproduct->seodescription_ar?$editproduct->seodescription_ar:old('seodescription_ar')}}@endif</textarea>
