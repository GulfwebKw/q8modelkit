                                        ...
                                        @endphp
											...
											<tr class="search-body">
                                                ...
                                                {{$productLists->firstItem() + $key}}
                                                 ...
                                                 <br><br>
                                                 <a title="{{trans('adminMessage.openlink')}}" class="btn btn-sm btn-clean btn-icon btn-icon-md mt-10" target="_blank" href="{{url(app()->getLocale().'/details/'.$productList->id.'/'.$productList->slug)}}"><i class="fa fa-link"></i></a>
                                                ...
                                                <tr><td width="120" style="color:#990000;">{{__('adminMessage.profit')}}</td><td style="color:#990000;">KD {{($productList->retail_price-$productList->cost_price)}}</td></tr>
                                                @endif
