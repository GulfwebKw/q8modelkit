													...
													<div class="form-group row">
														...
														<div class="col-3">
															<span class="kt-switch">
																<label>
																	<input type="checkbox" checked="checked" name="is_discount" id="is_discount" value="1"/>
																	<span></span>
																</label>
															</span>
														</div>
														...
														<div class="col-3">
															<input type="text" placeholder="Enter Discount" value="{{old('discount')}}" id="discount"  class="form-control {{$errors->has('discount')? 'is-invalid':''}} " name="discount" autocomplete="off" />
