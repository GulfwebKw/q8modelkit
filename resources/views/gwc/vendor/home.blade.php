...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>{{__('adminMessage.gulfwebvendor')}}|{{__('adminMessage.login')}}</title>
	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-aside--enabled kt-aside--fixed @if(!empty($settings->is_admin_menu_minimize)) kt-aside--minimize @endif  kt-page--loading">
		...
		<div class="kt-grid kt-grid--ver kt-grid--root">
			<div class="kt-grid kt-grid--hor kt-grid--root kt-login kt-login--v2 kt-login--signin" id="kt_login">
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" style="background-image: url({!! url('admin_assets/assets/media/bg/bg-5.jpg') !!});">
   ...
   @endphp 
							<div class="kt-login__signin">
								<div class="kt-login__head">
									<h3 class="kt-login__title">{{__('adminMessage.signinvendorpanel')}}</h3>
								</div>
   
								<form class="kt-form"  name="AdmloginForm" id="AdmloginForm" method="POST" action='{{ route("vendorlogin") }}'>
                                ...
                                @endif 
									...
									<div class="row kt-login__extra">
										<div class="col">
                                            ...
                                            <a style="color:#FFFFFF;" href="{{url('vendor/forgot')}}" class="pull-right">{{__('adminMessage.forgot_password')}}?</a>
										</div>
									</div>
