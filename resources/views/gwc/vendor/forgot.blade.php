...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>{{__('adminMessage.gulfwebvendor')}}|{{__('adminMessage.sendresetlink')}}</title>
					...
					<div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
						<div class="kt-login__container">
                         ...
                         <div class="kt-login__signin">
								...
								<form class="kt-form"  name="AdmfpForm" id="AdmfpForm" method="POST" action='{{ route("vendor.token",request()->token) }}'>
                         ...
                         @else   
   				         <div class="kt-login__signin">
								...
								<form class="kt-form"  name="AdmfpForm" id="AdmfpForm" method="POST" action='{{ route("vendor.email") }}'>
                                <input type="hidden" name="_token" value="{!! csrf_token() !!}">
