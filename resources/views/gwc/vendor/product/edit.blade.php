...
<html lang="en">
	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-aside--enabled kt-aside--fixed  @if(!empty($settings->is_admin_menu_minimize)) kt-aside--minimize @endif  kt-page--loading">
									...
									<div class="kt-grid__item">
											...
											<div class="kt-wizard-v1__nav">
												<div class="kt-wizard-v1__nav-items">
													...
													<div class="kt-wizard-v1__nav-item" data-ktwizard-type="step" @if(Request::is('vendor/product/*/categories')==true || Request::is('vendor/product/*/seo-tags')==true || Request::is('vendor/product/*/edit')==true || Request::is('vendor/product/*/gallery')==true || Request::is('vendor/product/*/attributes')==true  || Request::is('vendor/product/*/finish')==true || Request::is('vendor/product/*/options')==true || Request::is('vendor/product/*/editoptions/*')==true) data-ktwizard-state="current" @endif>                                    <a href="{{url('vendor/product/'.$editproduct->id.'/edit')}}">
                                                    ...
                                                    <div class="kt-wizard-v1__nav-item" data-ktwizard-type="step" @if(Request::is('vendor/product/*/categories')==true || Request::is('vendor/product/*/seo-tags')==true || Request::is('vendor/product/*/attributes')==true  || Request::is('vendor/product/*/finish')==true || Request::is('vendor/product/*/options')==true || Request::is('vendor/product/*/gallery')==true) data-ktwizard-state="current" @endif>
                                                    ...
                                                    <div class="kt-wizard-v1__nav-item" @if(Request::is('vendor/product/*/categories')==true || Request::is('vendor/product/*/seo-tags')==true || Request::is('vendor/product/*/gallery')==true || Request::is('vendor/product/*/finish')==true) data-ktwizard-state="current" @endif>
													...
													<div class="kt-wizard-v1__nav-item" data-ktwizard-type="step" @if(Request::is('vendor/product/*/seo-tags')==true || Request::is('vendor/product/*/gallery')==true || Request::is('vendor/product/*/finish')==true) data-ktwizard-state="current" @endif>
													...
													<div class="kt-wizard-v1__nav-item" @if(Request::is('vendor/product/*/seo-tags')==true || Request::is('vendor/product/*/finish')==true) data-ktwizard-state="current" @endif>
                                                    ...
                                                    <div class="kt-wizard-v1__nav-item" @if(Request::is('vendor/product/*/finish')==true) data-ktwizard-state="current" @endif>
                    ...
                    <form name="tFrm"  id="form_validation"  method="post"
                          ...
                          <input type="hidden" name="_token" value="{{ csrf_token() }}">
										...
										<div class="form-group row">
                                                ...
                                                <input type="text" class="form-control @if($errors->has('weight')) is-invalid @endif" name="weight"  value="{{$editproduct->weight?$editproduct->weight:old('weight')}}" autocomplete="off" />
                                                ...
                                                <input type="text" class="form-control @if($errors->has('height')) is-invalid @endif" name="height"  value="{{$editproduct->height?$editproduct->height:old('height')}}" autocomplete="off" />
                                                ...
                                                <input type="text" class="form-control @if($errors->has('width')) is-invalid @endif" name="width"  value="{{$editproduct->width?$editproduct->width:old('width')}}" autocomplete="off" />
                                                               @if($errors->has('width'))
                                                ...
                                                <input type="text" class="form-control @if($errors->has('depth')) is-invalid @endif" name="depth"  value="{{$editproduct->depth?$editproduct->depth:old('depth')}}" autocomplete="off" />
                                                               @if($errors->has('depth'))
                                                ...
                                                <input  type="text" class="form-control @if($errors->has('extra_title_en')) is-invalid @endif" name="extra_title_en"
                                                               value="{{$editproduct->extra_title_en?$editproduct->extra_title_en:old('extra_title_en')}}" autocomplete="off" placeholder="{{__('adminMessage.enter_title_en')}}" />
                                                ...
                                                <input  type="text" class="form-control @if($errors->has('extra_title_ar')) is-invalid @endif" name="extra_title_ar"
                                                               value="{{$editproduct->extra_title_ar?$editproduct->extra_title_ar:old('extra_title_ar')}}" autocomplete="off" placeholder="{{__('adminMessage.enter_title_ar')}}" />
                                          ...
                                          <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <input type="text" class="form-control @if($errors->has('cost_price')) is-invalid @endif" name="cost_price" id="cost_price"
                                                               value="{{$editproduct->cost_price?$editproduct->cost_price:old('cost_price')}}" autocomplete="off" placeholder="{{__('adminMessage.enter_cost_price')}}" />
                                                ...
                                                <input type="text" class="form-control @if($errors->has('wholesale_price')) is-invalid @endif" name="wholesale_price"
                                                               value="{{$editproduct->wholesale_price?$editproduct->wholesale_price:old('wholesale_price')}}" autocomplete="off" placeholder="{{__('adminMessage.enter_wholesale_price')}}" />
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <img class="pull-right" src="{!! url('uploads/product/thumb/'.$editproduct->image) !!}" width="35" height="35">
                                                <a href="{{url('vendor/product/deleteImage/'.$editproduct->id)}}" class="btn btn-brand btn-danger pull-right btn-icon-sm btn-sm "><i class="la la-trash"></i>{{__('adminMessage.delete')}}</a>
                                                @endif
                                                ...
                                                <div class="col-lg-4">
                                                        ...
                                                        <img  class="pull-right" src="{!! url('uploads/product/thumb/'.$editproduct->rollover_image) !!}" width="35" height="35">
                                                        <a href="{{url('vendor/product/deleteRolloverImage/'.$editproduct->id)}}" class="btn btn-brand btn-danger pull-right btn-icon-sm btn-sm "><i class="la la-trash"></i>{{__('adminMessage.delete')}}</a>
                                                        @endif
                                                ...
                                                <div class="col-lg-4">
                                                        ...
                                                        <a href="{{url('vendor/product/deletePdf/'.$editproduct->id)}}" class="btn btn-brand btn-danger pull-right btn-icon-sm btn-sm "><i class="la la-trash"></i>{{__('adminMessage.delete')}}</a>
                                                        @endif
											...
											<div class="kt-portlet__foot">
												<div class="kt-form__actions">
													...
													<button type="button" onClick="Javascript:window.location.href='{{url('vendor/product')}}'"  class="btn btn-secondary kt-pull-right cancelbtn">{{__('adminMessage.backtolisting')}}</button>
     ...
     @if($chosenCustomOption->option_type=="select" || $chosenCustomOption->option_type=="radio" || $chosenCustomOption->option_type=="checkbox")                                   
    <div class="kt-portlet kt-portlet--fit kt-portlet--head-noborder kt-portlet--height-fluid-half" style="border:1px #ccc solid;padding:10px;">
                                    ...
                                    @endif
                                            ...
                                            <div class="kt-portlet__foot">
												<div class="kt-form__actions">
                                                    ...
                                                    <button type="button" onClick="Javascript:window.location.href='{{url('vendor/product/'.request()->id.'/edit')}}'"  class="btn btn-secondary kt-pull-right cancelbtn">{{__('adminMessage.backtodetails')}}</button>
												</div>
											</div>
                                            </form>
                                       ...
                                       <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                        ...
                                        @endforeach
                                                            ...
                                                            <a href="javascript:;" title="{{__('adminMessage.savechanges')}}"  class="btn-sm btn btn-label-info btn-bold updateCategoryDetails" id="{{$listCategory->id}}">
																...
																<a href="{{url('vendor/product/'.$editproduct->id.'/deleteprodcategory/'.$listCategory->id)}}"  title="{{__('adminMessage.delete')}}"  class="btn-sm btn btn-label-danger btn-bold">
																	<i class="la la-trash-o"></i>
																</a>
                                        ...
                                        @endforeach
                                            ...
                                            <div class="kt-portlet__foot">
												<div class="kt-form__actions">
													...
													<button type="button" onClick="Javascript:window.location.href='{{url('vendor/product/'.request()->id.'/options')}}'"  class="btn btn-secondary kt-pull-right cancelbtn">{{__('adminMessage.backtooptions')}}</button>
												</div>
											</div>
                                            </form>
                                      ...
                                      <!-- product categories end -->
                                       ...
                                       @if(Request::is('vendor/product/*/gallery')==true)
                                        <form id="galleryImageForm" method="post" action="{{route('uploadgalleryimages',$editproduct->id)}}" enctype="multipart/form-data">
                                       <div class="kt-portlet__body">
                                            <div class="form-group row">{!!__('adminMessage.browse_images')!!}</div>
													...
													<div class="row form-group">
														<div class="col-md-6">
															<input placeholder="{{trans('adminMessage.enter_title_en')}}" class="form-control" type="text" name="title_en" id="title_en"  />
														</div>
                                                        <div class="col-md-6">
															<input placeholder="{{trans('adminMessage.enter_title_ar')}}" class="form-control" type="text" name="title_ar" id="title_ar"  />
														</div>
													</div>	
                                                    <div class="form-group ">
                                                ...
                                                <img src="{!! url('uploads/product/thumb/'.$listGallery->image) !!}" width="200" style="margin:3px;">
                                                <a href="{{url('vendor/product/'.$editproduct->id.'/deletegallery/'.$listGallery->id)}}" class="btn btn-danger btn-sm">Delete</a>
                                                </div>
                                                @endif
                                                @endforeach
                                                @endif
                                         ...
                                         <div class="kt-portlet__foot">
												<div class="kt-form__actions">
													<button type="submit" class="btn btn-success">{{__('adminMessage.next')}}<i class="la la-angle-double-right"></i></button>
                                                    <label for="redirect_to_listing"><input type="checkbox" name="redirect_to_listing" id="redirect_to_listing" value="1">&nbsp;{{__('adminMessage.saveandredirecttolisting')}}</label>
													<button type="button" onClick="Javascript:window.location.href='{{url('vendor/product/'.request()->id.'/categories')}}'"  class="btn btn-secondary kt-pull-right cancelbtn">{{__('adminMessage.backtocategory')}}</button>
												</div>
											</div>
                                            </form>
                                       @endif
                                       ...
                                       <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                            ...
                                            <div class="kt-portlet__foot">
												<div class="kt-form__actions">
													<button type="submit" class="btn btn-success">{{__('adminMessage.next')}}<i class="la la-angle-double-right"></i></button>
                                                    <label for="redirect_to_listing"><input type="checkbox" name="redirect_to_listing" id="redirect_to_listing" value="1">&nbsp;{{__('adminMessage.saveandredirecttolisting')}}</label>
													<button type="button" onClick="Javascript:window.location.href='{{url('vendor/product/'.request()->id.'/gallery')}}'"  class="btn btn-secondary kt-pull-right cancelbtn">{{__('adminMessage.backtogallery')}}</button>
												</div>
											</div>
                                            </form>
                                           ...
                                           <div class="form-group row">
                                            ...
                                            <div class="kt-portlet__foot">
												<div class="kt-form__actions">
													...
													<button type="button" onClick="Javascript:window.location.href='{{url('vendor/product/'.request()->id.'/seo-tags')}}'"  class="btn btn-secondary kt-pull-right cancelbtn">{{__('adminMessage.backtoseotags')}}</button>
												</div>
											</div>
                                            </form>  
                                       @endif
