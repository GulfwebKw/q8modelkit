    ...
    <div class="kt-grid kt-grid--hor kt-grid--root">
                                            ...
                                            <div class="kt-portlet__body">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text"
                                                                class="form-control @if ($errors->has('name_en')) is-invalid @endif" name="name_en" placeholder="{{ __('adminMessage.enter_websitename_en') }}" value="@if ($settingDetails->name_en){{ $settingDetails->name_en }}@endif">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input dir="rtl" type="text"
                                                                class="form-control @if ($errors->has('name_ar')) is-invalid @endif" name="name_ar" placeholder="{{ __('adminMessage.enter_websitename_ar') }}" value="@if ($settingDetails->name_ar){{ $settingDetails->name_ar }}@endif">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea rows="5" type="text"
                                                        class="form-control  @if ($errors->has('seo_description_en')) is-invalid @endif" name="seo_description_en" placeholder="{{ __('adminMessage.enterseodescription_en') }}">@if ($settingDetails->seo_description_en){!! $settingDetails->seo_description_en !!}@endif</textarea>
        ...
        <div class="col-md-12">
           ...
           <input type="text" class="form-control @if ($errors->has('instagram_userId')) is-invalid @endif" name="instagram_userId" value="@if ($settingDetails->instagram_userId){{ $settingDetails->instagram_userId }}@endif" placeholder="Enter Instagram User id">
            ...
            <div class="input-group-prepend"><span class="input-group-text" style="width:138px;height:40px;">Columns(3)&nbsp;<input @if (!empty($settingDetails->column_list) && $settingDetails->column_list == 1) checked @endif  type="radio" class="form-control" name="column_list" value="1" style="width:30px;padding:5px;border:0;"></span></div>
                                                ...
                                                <div class="form-group "><h5>{{ __('adminMessage.postknet_note') }}</h5></div>
                                                <div class="form-group">
             <textarea rows="5" type="text" class="form-control  @if ($errors->has('postknet_note_en')) is-invalid @endif" name="postknet_note_en" placeholder="{{ __('adminMessage.enterpostknet_note_en') }}">@if ($settingDetails->postknet_note_en){!! $settingDetails->postknet_note_en !!}@endif</textarea>
                                                    @if ($errors->has('postknet_note_en'))
                                                    <div class="invalid-feedback">{{ $errors->first('postknet_note_en') }}</div>
                                                    @endif
            </div>
                                                <div class="form-group">
             <textarea rows="5" dir="rtl" type="text" class="form-control  @if ($errors->has('postknet_note_ar')) is-invalid @endif" name="postknet_note_ar" placeholder="{{ __('adminMessage.enterpostknet_note_ar') }}">@if ($settingDetails->postknet_note_ar){!! $settingDetails->postknet_note_ar !!}@endif</textarea>
        ...
        <div class="col-md-6">
         ...
         <div class="kt-portlet">
          <div class="kt-portlet__head">
           ...
           <button type="submit" class="btn btn-success" style="float:right;">{{ __('adminMessage.save') }}</button>
          </div>
        ...
        <div class="col-md-6">
            ...
            <input value="1" {{ !empty($settingDetails->invoice_template) && $settingDetails->invoice_template == 1 ? 'checked' : '' }} type="radio"  id="invoice_template1" name="invoice_template"><span></span></label></span>
                                                <br>
                                                <a href="{{ url('uploads/screen1.png') }}" target="_blank"><img width="200" src="{{ url('uploads/screen1.png') }}"></a>
                                                </div>
                                                <div class="col-md-6">
                                                <span class="kt-switch"><label>
            <input value="2" {{ !empty($settingDetails->invoice_template) && $settingDetails->invoice_template == 2 ? 'checked' : '' }} type="radio"  id="invoice_template2" name="invoice_template"><span></span></label></span>
                                                <br>
                                                <a href="{{ url('uploads/screen2.png') }}" target="_blank"><img width="200"  src="{{ url('uploads/screen2.png') }}"></a>
                                                </div>
                                                </div>
                                                </div>
