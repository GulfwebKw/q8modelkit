...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>{{__('adminMessage.websiteName')}}|{{__('adminMessage.createmanufacturer')}}</title>
				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					...
					<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									...
									<div class="kt-subheader__breadcrumbs">
										...
										<a href="javascript:;" class="kt-subheader__breadcrumbs-link">{{__('adminMessage.createmanufacturer')}}</a>
									</div>
								</div>
						...
						<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title">{{__('adminMessage.createmanufacturer')}}</h3>
									</div>
					...
					@if(auth()->guard('admin')->user()->can('manufacturer-create'))
                         ...
                         <form name="tFrm"  id="form_validation"  method="post"
                          class="kt-form" enctype="multipart/form-data" action="{{route('manufacturer.store')}}">
                          <input type="hidden" name="_token" value="{{ csrf_token() }}">
											<div class="kt-portlet__body">
										   <div class="form-group row">
                                                <div class="col-lg-12"><h5>{{__('adminMessage.personalinformation')}}</h5></div>
                                           </div>     											
                                           <div class="form-group row">
                                                <div class="col-lg-3">
                                         ...
                                         <div class="form-group row">
                                                <div class="col-lg-6">
                                                 ...
                                                 <div class="col-lg-6">
														...
														<input type="file" class="custom-file-input @if($errors->has('header_image')) is-invalid @endif"  id="header_image" name="image">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-lg-12"><h5>{{__('adminMessage.logininformation')}}</h5><br>Note : Mobile number will be the default username & password</div>
                                           </div> 
