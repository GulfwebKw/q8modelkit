                                            ...
                                            <div class="tt-product thumbprod-center">
                                                <div class="tt-image-box">
                                                    ...
                                                    <a href="javascript:;" class="tt-btn-wishlist addtowishlistquick"
                                                        ...
                                                        id="{{ $homesetionsprod->id }}"></a>
                                                    <a
                                                        href="{{ url('directdetails/' . $homesetionsprod->id . '/' . $homesetionsprod->slug . '/' . $strLang) }}">
                                                ...
                                                <div class="tt-description">
                                                    ...
                                                    <h2 class="tt-title" style="min-height:70px;"><a
                                                            href="{{ url('directdetails/' . $homesetionsprod->id . '/' . $homesetionsprod->slug . '/' . $strLang) }}">@if (app()->getLocale() == 'en') {{ $homesetionsprod->title_en }} @else {{ $homesetionsprod->title_ar }} @endif</a>
                                                    </h2>
                                                    @if (!empty($tagsDetails)){!! $tagsDetails !!}@endif
                                                    <div class="tt-price">
                                                        @if (!empty($homesetionsprod->countdown_datetime) && strtotime($homesetionsprod->countdown_datetime) > strtotime(date('Y-m-d')))
                                                            <span
                                                                class="new-price">{{ $homesetionsprod->countdown_price }}
                                                        ...
                                                        @else
                                                            <span
                                                                class="new-price">{{ $homesetionsprod->retail_price }}
                                                                {{ __('webMessage.kd') }}</span>
                                                            <input type="hidden"
                                                                id="pixel_price_{{ $homesetionsprod->id }}"
                                                            ...
                                                            @if (!empty($homesetionsprod->old_price))<br />
                                                                <span
                                                                    class="old-price">{{ $homesetionsprod->old_price }}
                                                                    {{ __('webMessage.kd') }}</span>
                                                            @endif
                                                        @endif
                                                    </div>
                                                    <div class="tt-product-inside-hover">
                                                        <div class="tt-row-btn">
                                                            @if ($homesetionsprod->is_attribute)
                                                                <a href="{{ url('directdetails/' . $homesetionsprod->id . '/' . $homesetionsprod->slug . '/' . $strLang) }}"
