...
<body>
    ...
    <div id="tt-pageContent">
        ...
        @php
            ...
            $strLang = app()->getLocale() == 'ar' ? 'ar' : 'en';
        @endphp
                        ...
                        <div class="container-indent">
                            <div class="container container-fluid-custom-mobile-padding">
                                <div class="tt-block-title">
                                    <h1 class="tt-title noborder"><a @if ($settingInfo->theme == 7) style="color:#000; text-decoration:none !important;" @endif href="{{ url(app()->getLocale() . '/allsections/' . $homesetion->id . '/' . $homesetion->slug) }}">@if (app()->getLocale() == 'en'){{ strtoupper($homesetion->title_en) }}@else{{ $homesetion->title_ar }}@endif</a></h1>
                                        ...
                                        <div class="col-2 col-md-4 col-lg-3">
                                            <div class="tt-product thumbprod-center">
                                                ...
                                                <div class="tt-description">
                                                    ...
                                                    <h2 class="tt-title" style="min-height:70px;"><a
                                                            href="{{ url(app()->getLocale() . '/directdetails/' . $homesetionsprod->id . '/' . $homesetionsprod->slug) }}">@if (app()->getLocale() == 'en') {{ $homesetionsprod->title_en }} @else {{ $homesetionsprod->title_ar }} @endif</a>
                                                    </h2>
                                                    ...
                                                    <div class="tt-price">
                                                        @if (!empty($homesetionsprod->countdown_datetime) && strtotime($homesetionsprod->countdown_datetime) > strtotime(date('Y-m-d')))
                                                            ...
                                                            @if (!empty($homesetionsprod->retail_price))
                                                                <br />
                                                        ...
                                                        @elseif ($checkBrandDiscount)
                                                            ...
                                                            <span
                                                                ...
                                                                {{ __('webMessage.kd') }}</span>
                                                        @else
                                                            <span class="new-price @if ($homesetionsprod->old_price) price_red @endif">
                                                                {{ $homesetionsprod->retail_price }}
                                                                {{ __('webMessage.kd') }} </span>
                                                            <input type="hidden"
                                                                id="pixel_price_{{ $homesetionsprod->id }}"
