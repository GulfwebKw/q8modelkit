...
<body>
    ...
    <div id="tt-pageContent">
        ...
        <!--home slideshow -->
        @include("website.includes.slideshow_theme17")
        <!--load theme start -->
        @php
                        ...
                        <div class="container-indent">
                            <div class="container container-fluid-custom-mobile-padding">
                                <div class="tt-block-title">
                                    ...
                                    <h1 class="tt-title tt-title-span"><span><a @if ($settingInfo->theme == 17) style="margin:20px 0; color:#f29a33; font-weight:bold; font-size:25px;" @endif href="{{ empty($homesetion->link)? url(app()->getLocale() . '/allsections/' . $homesetion->id . '/' . $homesetion->slug): $homesetion->link }}">@if (app()->getLocale() == 'en'){{ strtoupper($homesetion->title_en) }}@else{{ $homesetion->title_ar }}@endif</a></span></h1>
                                ...
                                <div
                                    ...
                                    @foreach ($homesetionsprods as $homesetionsprod)
                                        @php
                                            ...
                                            $checkBrandDiscount = App\Http\Controllers\webController::checkBrandDiscount($homesetionsprod->brand_id);
                                            $brandDiscountedPrice = App\Http\Controllers\webController::calByBrandDiscount($homesetionsprod->brand_id, $homesetionsprod->retail_price);
                                        @endphp
                                        <div class="col-2 col-md-4 col-lg-3 " style="height:  ;">
                                            <div class="card tt-product thumbprod-center">
                                                ...
                                                <div class="tt-description" align="center">
                                                    ...
                                                    <div class="tt-price">
                                                        ...
                                                        @if (!empty($homesetionsprod->countdown_datetime) && strtotime($homesetionsprod->countdown_datetime) > strtotime(date('Y-m-d')))
                                                            <span
                                                                class="new-price">{{ $homesetionsprod->countdown_price }}{{ __('webMessage.kd') }}</span>
                                                            @if (!empty($homesetionsprod->retail_price))<br />
                                                                <span
                                                                    class="old-price">{{ $homesetionsprod->retail_price }}
                                                        ...
                                                        <div class="tt-row-btn">
                                                            @if ($homesetionsprod->is_attribute)
                                                                <a href="{{ url(app()->getLocale() . '/directdetails/' . $homesetionsprod->id . '/' . $homesetionsprod->slug) }}"
                                                                    ...
                                                                    id="{{ $homesetionsprod->id }}">{{ __('webMessage.details') }}
                                                                </a>
                                                                </a>
                                                            @else
                                                                @if (!empty($isStock))
                                                                    @if ($homesetionsprod->is_active == '2')
                                                                        <a href="javascript:;"
                                                                            class="tt-btn-addtocart thumbprod-button-bg addtocartsingle @if (!empty($settingInfo->facebook_pixel)) addToCartPixelButton @endif"
                                                                            id="{{ $homesetionsprod->id }}">{{ __('webMessage.preorder') }}
                                                                        </a>
                                                                    @else
                                                                        <a href="javascript:;"
                                                                            class="tt-btn-addtocart thumbprod-button-bg addtocartsingle @if (!empty($settingInfo->facebook_pixel)) addToCartPixelButton @endif"
                                                                            id="{{ $homesetionsprod->id }}">{{ __('webMessage.addtocart_btn') }}
            ...
            <div class="modal-content ">
                ...
                <div class="modal-body">
                    <div class="tt-modal-addtocart mobile">
                        ...
                        <a href="shopping_cart.html" class="btn-link">View Cart</a>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6">
                                ...
                                <div class="tt-modal-product">
                                    <div class="tt-img">
                                        <img src="images/loader.svg" data-src="images/skin-toys/product/product-01.jpg"
                                            alt="">
                                    </div>
                                ...
                                <div class="tt-product-total">
                                    <div class="tt-total">
                                        TOTAL: <span class="tt-price">KD 324</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-lg-6">
                                ...
                                <a href="shopping_cart.html" class="btn btn-border">View Cart</a>
    ...
    <!-- modal (quickViewModal) -->
    <div class="modal  fade" id="ModalquickViewProd" tabindex="-1" role="dialog" aria-label="myModalLabel"
        aria-hidden="true">
    ...
    @endif
    @if (!empty($settingInfo->is_home_popup))
        <script>
            $(document).ready(function() {
                $("#homemodalbox").modal('show');
            });
        </script>
    @endif
</body>
