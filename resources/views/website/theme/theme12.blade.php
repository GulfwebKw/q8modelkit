...
<div class="container-indent">
		<div class="container container-fluid-custom-mobile-padding">
			<div class="tt-block-title">
				<h1 class="tt-title tt-title-span"><span><a @if($settingInfo->theme==7) style="color:#000; text-decoration:none !important;" @endif href="{{url('allsections/'.$homesetion->id.'/'.$homesetion->slug)}}">@if(app()->getLocale()=="en"){{strtoupper($homesetion->title_en)}}@else{{$homesetion->title_ar}}@endif</a></span></h1>
                ...
                <div class="col-2 col-md-4 col-lg-3">
                    <div class="tt-product thumbprod-center">
                        ...
                        <span id="responseMsg-{{$homesetionsprod->id}}"></span> 
							<h2 class="tt-title"><a href="{{url('directdetails/'.$homesetionsprod->id.'/'.$homesetionsprod->slug.'/'.$strLang)}}">{!!Common::getLangString($homesetionsprod->title_en,$homesetionsprod->title_ar)!!}{!!Common::getLangStringExtra($homesetionsprod->extra_title_en,$homesetionsprod->extra_title_ar)!!}</a></h2>
