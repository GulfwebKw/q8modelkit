                ...
                <div class="col-2 col-md-4 col-lg-3">
                    <div class="tt-product thumbprod-center">
                        ...
                        <span id="responseMsg-{{$homesetionsprod->id}}"></span> 
							...
							<div class="tt-price">
							@if(!empty($homesetionsprod->countdown_datetime) && strtotime($homesetionsprod->countdown_datetime)>strtotime(date('Y-m-d'))) 	                            <span class="new-price price_red">{{$homesetionsprod->countdown_price}} {{__('webMessage.kd')}}</span>
