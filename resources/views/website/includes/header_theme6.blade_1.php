			...
			<div class="tt-header-row tt-top-row">
				...
				<div class="tt-col-right ml-auto">
					<ul class="tt-social-icon">
						...
						<li><a title="{{__('webMessage.whatsapp')}}" class="icon-h-11" target="_blank" href="{{$settingInfo->social_whatsapp}}"></a></li>
                        @endif					
				...
				<div class="col-8 col-lg-8">
					<div class="tt-search-type2 size-large tt-full-width tt-no-btn ">
						...
						<form name="topsearchform1" id="topsearchform1" method="get" action="{{url(app()->getLocale().'/search')}}">
							<i class="icon-f-85"></i>
							<input class="tt-search-input" type="text" name="sq" id="search_keyname" placeholder="{{__('webMessage.searchproducts')}}" value="@if(Request()->sq){{Request()->sq}}@endif" autocomplete="off">
				...
				<div class="tt-header-holder">
					<div class="tt-obj-menu">
						...
						<div class="tt-desctop-menu">
							<nav>
								<ul>
                                    <li class="dropdown tt-megamenu-col-02 selected"><a href="{{url('/'.app()->getLocale())}}">{{__('webMessage.home')}}</a></li>
	...
	<div class="tt-stuck-nav">
		<div class="container">
			<div class="tt-header-row ">
				...
				<div class="tt-stuck-parent-multi tt-parent-box">
                            @if($settingInfo->is_lang==1)
                             @if(app()->getLocale()=='ar')
							<button onclick="javascript:window.location.href='{{ url('en/' . substr(Request::getRequestUri(), 4, strlen(Request::getRequestUri()))) }}'" class="languageButton" data-tooltip="{{__('webMessage.english')}}">E</button>
                            @else
