					...
					<div class="tt-desctop-parent-multi tt-parent-box">
						<div class="tt-multi-obj tt-dropdown-obj">
                            @if($settingInfo->is_lang==1)
                             @if(app()->getLocale()=='ar')
							<button onclick="javascript:window.location.href='{{ url('locale/en') }}'" class="languageButton" data-tooltip="{{__('webMessage.english')}}">{{trans('webMessage.english')}}</button>
                            @else
                            <button onclick="javascript:window.location.href='{{ url('locale/ar') }}'" class="languageButton" data-tooltip="{{__('webMessage.arabic')}}">{{trans('webMessage.arabic')}}</button>
                            @endif
                            @endif
						</div>
					</div>
