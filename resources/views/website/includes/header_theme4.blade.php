										...
										<div class="tt-cart-content">
                                            ...
                                            @endphp
												<div class="tt-item" style="@if($t>3) display:none; @endif" >
													<a href="{{url('directdetails/'.$prodDetails->id.'/'.$prodDetails->slug.'/'.$strLang)}}">
					...
					<div class="tt-desctop-parent-multi tt-parent-box">
						<div class="tt-multi-obj tt-dropdown-obj">
                            @if($settingInfo->is_lang==1)
                             @if(app()->getLocale()=='ar')
							<button onclick="javascript:window.location.href='{{ url('locale/en') }}'" class="languageButton" data-tooltip="{{__('webMessage.english')}}"><img src="{{url('uploads/en.png')}}" height="15" style="margin-top:5px;"/></button>
                            @else
                            <button onclick="javascript:window.location.href='{{ url('locale/ar') }}'" class="languageButton" data-tooltip="{{__('webMessage.arabic')}}"><img src="{{url('uploads/ar.png')}}"  height="15" style="margin-top:5px;"/></button>
                            @endif
                            @endif
						</div>
					</div>
				...
				<div class="tt-obj-menu obj-aligment-center">
					...
					<div class="tt-desctop-parent-menu tt-parent-box">
						<div class="tt-desctop-menu tt-menu-small">
							<nav>
								<ul>
                                    {{-- <li class="dropdown tt-megamenu-col-02 selected"><a href="{{url('/')}}">{{__('webMessage.home')}}</a></li> --}}
