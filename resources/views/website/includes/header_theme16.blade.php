...
<header id="tt-header">
    ...
    <nav class="panel-menu mobile-main-menu">
        <ul>
            ...
            @endif
            <li class="deals"><a href="{{ url('/offers') }}">{{ __('webMessage.offers') }}</a></li>
            ...
            <li><a href="{{ url('/page/' . $privacy_details->slug) }}">{{ __('webMessage.privacypolicy') }}</a>
            </li>
            <li><a href="{{ url('/page/' . $terms_details->slug) }}">{{ __('webMessage.termsconditions') }}</a>
            </li>
                ...
                <div class="tt-logo-container">
                    ...
                    @if ($settingInfo->logo)
                        <a class="tt-logo tt-logo-alignment" href="{{ url('/') }}"><img
                                src="{{ url('uploads/logo/' . $settingInfo->logo) }}"
                                                ...
                                                <div class="tt-cart-list">
                                                    ...
                                                    @foreach ($tempOrders as $tempOrder)
                                                        ...
                                                        <div class="tt-item" @if ($t > 3)style="display:none;"@endif>
                                                            <a
                                                                href="{{ url('directdetails/' . $prodDetails->id . '/' . $prodDetails->slug . '/' . $strLang) }}">
                                                    ...
                                                    @if ($t > 3)
                                                        <div class="tt-item" align="center"><a
                                                                href="{{ url('/cart') }}">{{ trans('webMessage.viewall') }}(+{{ $t - 4 }})</a>
                                                        </div>
                                                    @endif
                                                </div>
                            ...
                            <div class="tt-dropdown-menu">
                                ...
                                <div class="tt-dropdown-inner">
                                    <ul>
                                        ...
                                        <li><a href="{{ url('/checkout') }}"><i class="icon-f-68"></i>Check
                                                Out</a></li>
                                        ...
                                        <form id="logout-forms" action="{{ url('/logout') }}" method="POST"
                                            style="display: none;">
                    ...
                    <div class="tt-desctop-parent-multi tt-parent-box">
                        <div class="tt-multi-obj tt-dropdown-obj">
                            ...
                            <div class="tt-dropdown-menu">
                                ...
                                <div class="tt-dropdown-inner">
                                    <ul>
                                        <li class="active"><a href="{{ url('locale/en') }}">English</a></li>
                ...
                <div class="tt-header-holder">
                    <div class="tt-obj-menu">
                        ...
                        <div class="tt-desctop-parent-menu tt-parent-box">
                            <div class="tt-desctop-menu tt-hover-02" id="js-include-desktop-menu">
                                <nav>
                                    <ul>
                                        <li class="dropdown megamenu"><a
                                                href="{{ url('/') }}">{{ __('webMessage.home') }}</a></li>
                                                                    ...
                                                                    <div class="row tt-col-list">
                                                                        @foreach ($desktopMenusTree->childs as $childCategory)
                                                                            <div class="col-sm-4">
                                                                                ...
                                                                                <a href="{{ url('/products/' . $childCategory->id . '/' . $childCategory->friendly_url) }}"
                                                                                ...
                                                                                @if (!empty($childCategory->childs) && count($childCategory->childs) > 0)
                                                                                    ...
                                                                                    <ul class="tt-megamenu-submenu">
                                                                                        @foreach ($childCategory->childs as $subchildCategory)
                                                                                            <li><a
                                                                                                    href="{{ url('/products/' . $subchildCategory->id . '/' . $subchildCategory->friendly_url) }}">@if (app()->getLocale() == 'en') {{ $subchildCategory->name_en }} @else {{ $subchildCategory->name_ar }} @endif</a>
                                                                                            </li>
                                                                                        @endforeach
                                                                                    </ul>
                                                                                @endif
                                                                ...
                                                                @foreach ($desktopMenusTree->childs as $childCategory)
                                                                    <div class="col">
                                                                        <h6 class="tt-title-submenu"><a
                                                                                href="{{ url('/products/' . $childCategory->id . '/' . $childCategory->friendly_url) }}">@if (app()->getLocale() == 'en') {{ $childCategory->name_en }} @else {{ $childCategory->name_ar }} @endif</a>
                                                                        </h6>
                                                                        @if (!empty($childCategory->childs) && count($childCategory->childs) > 0)
                                                                            <ul class="tt-megamenu-submenu">
                                                                                @foreach ($childCategory->childs as $subchildCategory)
                        ...
                        @else
                            <li class="dropdown @if (!empty($desktopMenusTree->is_highlighted)) deals @endif"><a href="{{ url('/products/' . $desktopMenusTree->id . '/' . $desktopMenusTree->friendly_url) }}">@if (app()->getLocale() == 'en') {{ $desktopMenusTree->name_en }} @else {{ $desktopMenusTree->name_ar }} @endif</a></li>
										...
										<li class="
                                dropdown deals"><a href="{{ url('/offers') }}">{{ __('webMessage.offers') }}</a>
                            </li>
                            @endif
                                    ...
                                    <div class="dropdown-menu">
                                        <div class="row tt-col-list">
                                            @foreach ($brandMenus as $brandMenu)
                                                <div class="col-sm-2">
                                                    <a href="{{ url('/brands/' . $brandMenu->slug) }}">
                            ...
                            @if (!empty($settingInfo->is_more_menu))
                                <li class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <ul class="tt-megamenu-submenu">
                                            <li><a
                                                    href="{{ url('/page/' . $about_details->slug) }}">{{ __('webMessage.aboutus') }}</a>
                                            </li>
                                            <li><a
                                                    href="{{ url('/contactus') }}">{{ __('webMessage.contactus') }}</a>
                                            </li>
                                            <li><a
                                                    href="{{ url('/page/' . $privacy_details->slug) }}">{{ __('webMessage.privacypolicy') }}</a>
                                            </li>
                                            <li><a
                                                    href="{{ url('/page/' . $terms_details->slug) }}">{{ __('webMessage.termsconditions') }}</a>
                                            </li>
                                            <li><a href="{{ url('/faq') }}">{{ __('webMessage.faq') }}</a></li>
                                        </ul>
                                    </div>
