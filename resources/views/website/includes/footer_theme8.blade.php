			...
			<div class="row">
						...
						<div class="tt-collapse-content">
							<ul class="tt-list">
                              @foreach($footerMenusTrees as $footerMenusTree)
								<li><a href="{{url(app()->getLocale().'/products/'.$footerMenusTree->id.'/'.$footerMenusTree->friendly_url)}}">@if(app()->getLocale()=="en") {{$footerMenusTree->name_en}} @else {{$footerMenusTree->name_ar}} @endif</a></li>
                               @endforeach 
							</ul>
						</div>
                        @endif
				...
				<div class="col-md-3 col-lg-3 col-xl-3">
					<div class="tt-mobile-collapse">
						...
						<div class="tt-collapse-content">
							<ul class="tt-list">
							    @if(!empty($about_details->slug))<li><a href="{{url(app()->getLocale().'/page/'.$about_details->slug)}}">{{__('webMessage.aboutus')}}</a></li>@endif
								<li><a href="{{url(app()->getLocale().'/contactus')}}">{{__('webMessage.contactus')}}</a></li>
								
                                @if(!empty($privacy_details->slug))<li><a href="{{url(app()->getLocale().'/page/'.$privacy_details->slug)}}">{{__('webMessage.privacypolicy')}}</a></li>@endif
                                @if(!empty($terms_details->slug))<li><a href="{{url(app()->getLocale().'/page/'.$terms_details->slug)}}">{{__('webMessage.termsconditions')}}</a></li>@endif
                                <li><a href="{{url(app()->getLocale().'/faq')}}">{{__('webMessage.faq')}}</a></li>
                                @if($settingInfo->supplier_registration == 1)
									<li><a href="{{url(app()->getLocale().'/supplier-registration')}}">{{__('webMessage.supplier_registration')}}</a></li>
								@endif
							</ul>
						</div>
					</div>
					...
					<div class="tt-mobile-collapse">
						...
						<div class="tt-collapse-content">
							<ul class="tt-list">
								...
								<li><a href="{{url(app()->getLocale().'/account')}}">{{__('webMessage.dashboard')}}</a></li>
                                <li><a href="{{url(app()->getLocale().'/changepass')}}">{{__('webMessage.changepassword')}}</a></li>
                                <li><a href="{{url(app()->getLocale().'/editprofile')}}">{{__('webMessage.editprofile')}}</a></li>
                                <li><a href="{{url(app()->getLocale().'/myorders')}}">{{__('webMessage.myorders')}}</a></li>
                                <li><a href="{{url(app()->getLocale().'/wishlist')}}">{{__('webMessage.wishlist')}}</a></li>
								@else
								<li><a href="{{url(app()->getLocale().'/register')}}">{{__('webMessage.signup')}}</a></li>
								<li><a href="{{url(app()->getLocale().'/login')}}">{{__('webMessage.signin')}}</a></li>
								@endif
							</ul>
						</div>
					</div>
			...
			<div class="tt-row">
				<div class="tt-col-left">
					<div class="tt-col-item tt-logo-col">
						...
						<a class="tt-logo tt-logo-alignment" href="{{url('/'.app()->getLocale())}}"><img src="{{url('uploads/logo/'.$settingInfo->footerlogo)}}" title="@if(app()->getLocale()=="en") {{$settingInfo->name_en}} @else {{$settingInfo->name_ar}} @endif" alt="@if(app()->getLocale()=="en") {{$settingInfo->name_en}} @else {{$settingInfo->name_ar}} @endif"></a>
                        @endif
						<!-- /logo -->
					</div>
