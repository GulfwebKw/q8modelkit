...
<head>
<meta charset="utf-8">
<title>@if(app()->getLocale()=="en") {{$settingInfo->name_en}} @else {{$settingInfo->name_ar}} @endif | {{__('webMessage.editaddress')}}</title>
...
<div class="tt-breadcrumb">
	<div class="container">
		<ul>
			...
			<li>{{__('webMessage.editaddress')}}</li>
		</ul>
	</div>
</div>
<div id="tt-pageContent">
	<div class="container-indent">
		<div class="container">
			<h1 class="tt-title-subpages noborder">{{__('webMessage.editaddress')}}</h1>
