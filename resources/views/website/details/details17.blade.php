...
<head>
    ...
    <title>
        ...
        @elseif(app()->getLocale() == 'ar' && !empty($settingInfo->name_ar))
            {{ $settingInfo->name_ar }}
            @endif | @if (app()->getLocale() == 'en' && !empty($productDetails->title_en))
                {{ $productDetails->title_en }}
            @elseif(app()->getLocale() == 'ar' && !empty($productDetails->title_ar))
    ...
    <meta name="Copyright"
        content="@if (!empty($settingInfo->name_en)) {{ $settingInfo->name_en }} @endif, Kuwait Copyright 2020 - {{ date('Y') }}" />
    <META NAME="Geography"
        CONTENT="@if (app()->getLocale() == 'en' && !empty($settingInfo->address_en)) {{ $settingInfo->address_en }} @elseif(app()->getLocale() == 'ar' && !empty($settingInfo->address_ar)) {{ $settingInfo->address_ar }} @endif">
    @if (!empty($settingInfo->extra_meta_tags))
        {!! $settingInfo->extra_meta_tags !!}
    @endif
    ...
    @if (!empty($settingInfo->og_url))
        <meta property="og:url"
            content="{{ url('directdetails/' . $productDetails->id . '/' . $productDetails->slug) }}">
    @endif
...
<body>
        ...
        <div class="container">
            <ul itemscope itemtype="https://schema.org/BreadcrumbList">
                <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                    <a itemprop="item" href="{{ url('/' . app()->getLocale()) }}"><span
                            itemprop="name">{{ __('webMessage.home') }}</span></a>
    ...
    <div id="tt-pageContent" itemtype="http://schema.org/Product" itemscope>
        ...
        <meta itemprop="name"
            content="@if (app()->getLocale() == 'en' && !empty($productDetails->title_en)) {{ $productDetails->title_en }} @elseif(app()->getLocale() == 'ar' && !empty($productDetails->title_ar)) {{ $productDetails->title_ar }} @endif" />
        ...
        <div class="container-indent">
            ...
            <div class="tt-mobile-product-slider visible-xs arrow-location-center slick-animated-show-js">
                @if ($productDetails->image)
                    <div><img id="displaym-{{ $productDetails->id }}"
                            src="{{ url('uploads/product/' . $productDetails->image) }}" alt="">
                        <link itemprop="image" href="{{ url('uploads/product/' . $productDetails->image) }}" />
                    </div>
                @else
                    <div><img id="displaym-{{ $productDetails->id }}" src="{{ url('uploads/no-image.png') }}"
                            alt="">
                    </div>
                @endif
                @if (!empty($prodGalleries))
                    @foreach ($prodGalleries as $gallery)
                        <div><img src="{{ url('uploads/product/' . $gallery->image) }}" alt="">
                            <link itemprop="image" href="{{ url('uploads/product/' . $gallery->image) }}" />
                        </div>
                    @endforeach
                @endif
                    ...
                    <div>
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item"
                                src="https://www.youtube.com/embed/{{ $productDetails->youtube_url_id }}"
                ...
                <div class="row">
                    <div class="col-6 hidden-xs">
                        <div class="tt-product-single-img">
                            ...
                            <div>
                                @if ($productDetails->image)
                                    <img id="displayd-{{ $productDetails->id }}" class="zoom-product"
                                        src="{{ url('uploads/product/' . $productDetails->image) }}"
                                        data-zoom-image="{{ url('uploads/product/' . $productDetails->image) }}"
                                        alt="">
                                @else
                                    <img id="displayd-{{ $productDetails->id }}" class="zoom-product"
                                        src="{{ url('uploads/no-image.png') }}"
                                        data-zoom-image="{{ url('uploads/no-image.png') }}" alt="">
                                @endif
                        ...
                        <div class="product-images-carousel">
                            <ul id="smallGallery" class="arrow-location-02 slick-animated-show-js">
                                @if ($productDetails->image)
                                    <li><a id="displaya-{{ $productDetails->id }}" class="zoomGalleryActive"
                                            href="javascript:;"
                                            data-image="{{ url('uploads/product/' . $productDetails->image) }}"
                                            data-zoom-image="{{ url('uploads/product/' . $productDetails->image) }}"><img
                                                src="{{ url('uploads/product/thumb/' . $productDetails->image) }}"
                                                alt="" id="displayt-{{ $productDetails->id }}"></a></li>
                                @endif
                                @if (!empty($prodGalleries))
                                    @foreach ($prodGalleries as $gallery)
                                        <li><a href="javascript:;"
                                                data-image="{{ url('uploads/product/' . $gallery->image) }}"
                                                data-zoom-image="{{ url('uploads/product/' . $gallery->image) }}"><img
                                                    src="{{ url('uploads/product/thumb/' . $gallery->image) }}"
                                                    alt=""></a></li>
                                    @endforeach
                                @endif
                                @if ($productDetails->youtube_url_id)
                                    <li>
                                        <div class="video-link-product" data-toggle="modal" data-type="youtube"
                                            ...
                                            data-value="https://www.youtube.com/embed/{{ $productDetails->youtube_url_id }}">
                                            <img src="{{ url('assets/images/product/product-small-empty.png') }}"
                                                alt="">
                                            <div>
                                                <i class="icon-f-32"></i>
                                            </div>
                    ...
                    <div class="col-6">
                        <div class="tt-product-single-info">
                            @if (!empty($productDetails->caption_en) || !empty($productDetails->caption_ar))
                                <div class="tt-wrapper">
                                    <div class="tt-label">
                                        <span class="tt-label-location">
                                            @if (!empty($productDetails->caption_en) && $strLang == 'en')
                                                <span class="tt-label-sale"
                                                    style="background-color:{{ $productDetails['caption_color'] }};">{{ $productDetails->caption_en }}</span>
                                            @endif
                                            @if (!empty($productDetails->caption_ar) && $strLang == 'ar')
                                                <span class="tt-label-sale"
                                                    style="background-color:{{ $productDetails['caption_color'] }};">{{ $productDetails->caption_ar }}</span>
                                            @endif
                                        </span>
                                    </div>
                                </div>
                            ...
                            @if (!empty($brandDetails->image))
                                <a href="{{ url(app()->getLocale() . '/brands/' . $brandDetails->slug) }}">
                                    <img style="height:auto;width:150px;"
                            ...
                            <div class="tt-price">
                                @if (!empty($productDetails->countdown_datetime) && strtotime($productDetails->countdown_datetime) > strtotime(date('Y-m-d')))
                                    <span class="new-price @if ($productDetails->old_price) price_red @endif"><span
                                            id="">{{ round($productDetails->countdown_price, 3) }}</span>{{ __('webMessage.kd') }}</span>
                                    <span class="old-price price_black" id="oldprices"><small><span
                                                id="">{{ round($productDetails->retail_price, 3) }}</span>{{ __('webMessage.kd') }}</small></span>
                                    ...
                                    <div itemprop="offers" itemtype="http://schema.org/Offer" itemscope>
                                        ...
                                        <meta itemprop="price"
                                            content="{{ round($productDetails->countdown_price, 3) }}" />
                                        <meta itemprop="priceValidUntil"
                                            content="{{ date('Y-m-d', strtotime(date('Y-m-d') . '+10 days')) }}" />
                                    </div>
                                    <meta itemprop="sell_on_google_price"
                                        content="{{ round($productDetails->retail_price, 3) }} KWD" />
                                    <meta itemprop="sell_on_google_sale_price"
                                        content="{{ round($productDetails->countdown_price, 3) }} KWD" />
                                @elseif ($checkBrandDiscount)
                                    <span
                                        class="{{ $brandDiscountedPrice->oldPrice ? 'price_red' : '' }} new-price"><span
                                            id="">{{ $brandDiscountedPrice->price }}</span>{{ __('webMessage.kd') }}</span>
                                            @if(!empty($brandDiscountedPrice->oldPrice))
                                    <span class="old-price price_black" id="oldprices"><small><span
                                                id="">{{ $brandDiscountedPrice->oldPrice }}</span>{{ __('webMessage.kd') }}</small></span>
                                                @endif
                                    <div itemprop="offers" itemtype="http://schema.org/Offer" itemscope>
                                        <link itemprop="url"
                                            href="{{ url(app()->getLocale() . '/directdetails/' . $productDetails->id . '/' . $productDetails->slug) }}" />
                                    ...
                                    <meta itemprop="sell_on_google_sale_price"
                                        content="{{ round($productDetails->countdown_price, 3) }} KWD" />
                                @else
                                    <span class="@if ($productDetails->old_price) price_red @endif new-price"><span
                                            id="display_price">{{ round($productDetails->retail_price, 3) }}</span>{{ __('webMessage.kd') }}</span>
                                    @if ($productDetails->old_price)
                                        <span class="old-price price_black" id="oldprices"><small><span
                                                    id="display_oldprice">{{ round($productDetails->old_price, 3) }}</span>{{ __('webMessage.kd') }}</small></span>
                                        <meta itemprop="sell_on_google_price"
                                            content="{{ round($productDetails->old_price, 3) }} KWD" />
                                        <meta itemprop="sell_on_google_sale_price"
                                            content="{{ round($productDetails->retail_price, 3) }} KWD" />
                                    @else
                                        <meta itemprop="sell_on_google_price"
                                    ...
                                    <div itemprop="offers" itemtype="http://schema.org/Offer" itemscope>
                                        ...
                                        <meta itemprop="itemCondition" content="https://schema.org/New" />
                                        <meta itemprop="price"
                                            content="{{ round($productDetails->retail_price, 3) }}" />
                                        <meta itemprop="priceValidUntil"
                                            content="{{ date('Y-m-d', strtotime(date('Y-m-d') . '+10 days')) }}" />
                                    </div>
                            ...
                            <div class="tt-add-info">
                                <ul>
                                    @if (!empty($productDetails->item_code))
                                        <li><span>{{ __('webMessage.item_code') }}:</span>
                                            {{ $productDetails->item_code }}</li>
                                    @endif
                                    @if (!empty($productDetails->sku_no))
                                        <li><span>{{ __('webMessage.sku_no') }}:</span>
                                            {{ $productDetails->sku_no }}
                                        </li>
                                        <meta itemprop="sku" content="{{ $productDetails->sku_no }}" />
                                    @endif
                                    @if ($availableQty && ($availableQty > 0 && $availableQty <= 3))
                                        @if ($availableQty && $availableQty > 0)
                                            <li><span>{{ __('webMessage.availability') }}:</span> <span
                                                    id="display_qty">{{ $availableQty }}</span>
                                                <font color="#009900">{{ __('webMessage.instock') }}</font>
                                            </li>
                                        @else
                                            <li><span>{{ __('webMessage.availability') }}:</span> <span
                                                    id="display_qty">0</span>
                                                <font color="#ff0000">{{ __('webMessage.outofstock') }}</font>
                                            </li>
                                        @endif
                                    @endif
                            ...
                            @if ($productDetails->customizable)
                                <div>
                                    <a class="btn btn-primary"
                                        href="{{ url(app()->getLocale() . '/product/' . $productDetails->id . '/customize') }}"
                                        target="_blank">
                            ...
                            <div class="tt-review">
                                ...
                                <a href="#showreviews">({{ count($ReviewsLists) }}
                                    {{ __('webMessage.customerreview') }})</a>
                            </div>
                            @if (!empty($productDetails->countdown_datetime) && strtotime($productDetails->countdown_datetime) > strtotime(date('Y-m-d')))
                                <div class="tt-wrapper">
                                    <div class="tt-countdown_box_02">
                                        <div class="tt-countdown_inner">
                                            <div class="tt-countdown"
                                                ...
                                                data-year="Yrs" data-month="Mths" data-week="Wk" data-day="Day"
                                                data-hour="Hrs" data-minute="Min" data-second="Sec"></div>
                                        </div>
                                    </div>
                                </div>
                            @endif
                            <form name="addtocartDetailsForm" id="addtocartDetailsForm" method="POST"
                                action="{{ route('addtocartDetails') }}">
                                ...
                                @if (!empty($productDetails->is_attribute) && $availableQty > 0)
                                    <div class="tt-swatches-container">
                                        <img id="loader-gif" src="{{ url('assets/images/loader.svg') }}"
                                            style="position:absolute;margin-left:30%;display:none;margin-top:-40px;">
                                        <!--product options -->
                                        @if (!empty($productoptions) && count($productoptions) > 0)
                                            @foreach ($productoptions as $productoption)
                                                <input type="hidden" name="option_id[]"
                                                    id="option_id_{{ $productoption->id }}"
                                                                ...
                                                                <ul class="tt-options-swatch options-large">
                                                                    @foreach ($ColorAttributes as $ColorAttribute)
                                                                        ...
                                                                        @if (!empty($ColorAttribute->image))
                                                                            <li
                                                                                id="li-{{ $ColorAttribute->color_id }}">
                                                                                <a class="options-color"
                                                                                    href="javascript:;"
                                                                                    id="{{ $ColorAttribute->color_id }}">
                                                                                    <span class="swatch-img">
                                                                                        <img src="{{ url('uploads/color/thumb/' . $ColorAttribute->image) }}"
                                                                                            alt="">
                                                                                    </span>
                                                                                    <span
                                                                                        class="swatch-label color-black"></span>
                                                                                </a>
                                                                            </li>
                                                                        @else
                                                                            <li
                                                ...
                                                @else
                                                    ...
                                                    @if (!empty($customOptions['CustomOptionName']) && $customOptions['CustomOptionType'] == 'radio')
                                                        <div class="tt-wrapper">
                                                            <div class="tt-title-options">
                                                                {{ $customOptions['CustomOptionName'] }}
                                                                ...
                                                                @if (!empty($customOptions['childs']) && count($customOptions['childs']) > 0)
                                                                    ...
                                                                    @foreach ($customOptions['childs'] as $child)
                                                                        @php
                                                                            ...
                                                                            } elseif (!empty($child->retail_price) && !empty($child->is_price_add) && $child->is_price_add == 2) {
                                                                                $is_cadd = '-';
                                                                                $is_cadd_txt = $is_cadd . ' ' . $child->retail_price . ' ' . trans('webMessage.kd');
                                                                            } elseif (!empty($child->retail_price) && empty($child->is_price_add)) {
                                                                                $is_cadd = '';
                                                                        ...
                                                                        @endphp
                                                                        <li><label
                                                                                for="option-{{ $productDetails->id }}-{{ $productoption->custom_option_id }}-{{ $child->id }}"><input
                                                                                    ...
                                                                                    value="{{ $child->id }}">&nbsp;{{ $option_value_name }}({{ $is_cadd_txt }})</label>
                                                                        </li>
                                                                    @endforeach
                                                                @endif
                                                            </ul>
                                                    ...
                                                    @if (!empty($customOptions['CustomOptionName']) && $customOptions['CustomOptionType'] == 'checkbox')
                                                        <div class="tt-wrapper">
                                                            <div class="tt-title-options">
                                                                {{ $customOptions['CustomOptionName'] }}@if (!empty($productoption->is_required))
                                                                    *
                                                                @endif:
                                                            </div>
                                                            <ul class="optionradio">
                                                                @if (!empty($customOptions['childs']) && count($customOptions['childs']) > 0)
                                                                    ...
                                                                    @foreach ($customOptions['childs'] as $child)
                                                                        ...
                                                                        @endphp
                                                                        <li><label
                                                                                for="checkbox-{{ $productDetails->id }}-{{ $productoption->custom_option_id }}-{{ $child->id }}"><input
                                                                ...
                                                                <select class="form-control choose_select_options"
                                                                    ...
                                                                    @if (!empty($customOptions['childs']) && count($customOptions['childs']) > 0)
                                                                        ...
                                                                        @foreach ($customOptions['childs'] as $child)
                                                                            ...
                                                                            @endphp
                                                                            <option
                                                                                value="select-{{ $productDetails->id }}-{{ $productoption->custom_option_id }}-{{ $child->id }}">
                                                                                {{ $option_value_name }}({{ $is_cadd_txt }})
                                                                            </option>
                                                                        @endforeach
                                                                    @endif
                                                                </select>
                                            ...
                                            <div class="col-item">
                                                <div class="tt-input-counter style-01">
                                                    <span class="minus-btn"
                                                        id="{{ $productDetails->id }}"></span>
                                                    <input type="text" value="1" size="{{ $availableQty }}"
                                                ...
                                                @if ($productDetails->is_active == 2)
                                                    <button type="submit" class="btn btn-lg"
                                                        id="details_cartbtn"><img id="loader-details-gif"
                                                            src="{{ url('assets/images/loader.svg') }}"
                                                            style="position:absolute;margin-left:2%;display:none;margin-top:-1px;"><i
                                                            class="icon-f-39"></i>{{ __('webMessage.preorder') }}</button>
                                                @else
                                                    <button type="submit" class="btn btn-lg"
                                                        id="details_cartbtn"><img id="loader-details-gif"
                                                            src="{{ url('assets/images/loader.svg') }}"
                                                            style="position:absolute;margin-left:2%;display:none;margin-top:-1px;"><i
                                                            class="icon-f-39"></i>{{ __('webMessage.addtocart_btn') }}</button>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label for="inquiry_email"
                                                        class="control-label">{{ __('webMessage.email') }}
                                                        *</label>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label for="inquiry_mobile"
                                                        class="control-label">{{ __('webMessage.mobile') }}
                                                        *</label>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label for="inquiry_message"
                                                        class="control-label">{{ __('webMessage.message') }}
                                                    </label>
                                                    <textarea class="form-control" id="inquiry_message" name="inquiry_message"
                                                        placeholder="{{ __('webMessage.write_some_text') }}"
                                                        rows="4"></textarea>
                                                </div>
                                                <div class="form-group"><button type="button"
                                                        class="btn btn-lg btncartInquiry"
                                                        id="{{ $productDetails->id }}"><i
                                                            class="icon-f-39"></i>{{ __('webMessage.backorder') }}</button><img
                                                        width="40" src="{{ url('assets/images/ajax-loader.gif') }}"
                                                        id="loading-gif" style="display:none;"></div>
                                            </div>
                                        </div>
                            ...
                            <div class="tt-wrapper">
                                <div class="row">
                                    @if (!empty($productDetails->attachfile))
                                        <div class="col-3"><a class="btn-link" target="_blank"
                                                href="{{ url('uploads/product/' . $productDetails->attachfile) }}"><i
                                                    class="icon-e-39"></i>{{ strtoupper(__('webMessage.catalogue')) }}</a>
                                        </div>
                                    @endif
                                    <div class="col-6">
                                        <ul class="tt-list-btn">
                                            <li><a class="btn-link addtowishlist" href="javascript:;"
                                                    id="{{ $productDetails->id }}"><i
                                                        class="icon-n-072"></i>{{ strtoupper(__('webMessage.addtowishlist')) }}</a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                {{-- <div class="tt-collapse-block">
                                    <div class="tt-item ">
                                        <div class="tt-collapse-title">
                                            {{ strtoupper(__('webMessage.description')) }}
                                        </div>
                                        <div class="tt-collapse-content" itemprop="description"
                                            content="@if (app()->getLocale() == 'en') {!! strip_tags($productDetails->details_en) !!} @else {!! strip_tags($productDetails->details_ar) !!} @endif">
                                    ...
                                    <div class="tt-item active">
                                        ...
                                        <div class="tt-collapse-content">
                                            ...
                                            @php
                                                ...
                                                $doc = new DOMDocument();
                                                $doc->loadHTML($productDetails->details_en);
                                                $doc->formatOutput = true;
                                                $frameElement = $doc->getElementsByTagName('iframe');
                                                
                                                $vidLink = $frameElement->length > 0 ? $frameElement[0]->getAttribute('src') : '';
                                                
                                            @endphp
                                            @if (!empty($vidLink))
                                                <iframe frameborder="0" src="{{ $vidLink }}" width="640"
                                                    height="360" class="note-video-clip"></iframe>
                                            @else
                                                {{ str_limit(strip_tags(html_entity_decode(preg_replace('/\s\s+/',' ',app()->getLocale() == 'en' ? $productDetails->details_en : $productDetails->details_ar))),150) }}
                                            @endif
                                        </div>
                                    </div>
                                    <div class="tt-item">
                                        <div class="tt-collapse-title text-center">Read More </div>
                                        <div class="tt-collapse-content removeVid" itemprop="description"
                                            content='{!! app()->getLocale() == 'en' ? strip_tags($productDetails->details_en) : strip_tags($productDetails->details_ar) !!}'>
                                            {!! app()->getLocale() == 'en' ? $productDetails->details_en : $productDetails->details_ar !!}
                                        </div>
                            ...
                            @if (!empty($productDetails['warranty']))
                                ...
                                <div class="tt-collapse-block">
                                    <div class="tt-item active">
                                        <div class="tt-collapse-title">{{ strtoupper(__('webMessage.warranty')) }}
                                        </div>
                                        <div class="tt-collapse-content" style="display: block;">
                                            <p><strong>
                                                    @if (app()->getLocale() == 'en' && !empty($warrantyDetails->title_en))
                                                        {!! $warrantyDetails->title_en !!}
                                                    @elseif(app()->getLocale() == 'ar' && $warrantyDetails->title_ar)
                                                        {!! $warrantyDetails->title_ar !!}
                                                    @endif
                                                </strong></p>
                                            @if (app()->getLocale() == 'en' && !empty($warrantyDetails->details_en))
                                                {!! $warrantyDetails->details_en !!}
                                            @elseif(app()->getLocale() == 'ar' && !empty($warrantyDetails->details_ar))
                                                {!! $warrantyDetails->details_ar !!}
                                            @endif
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="container-indent">
                        <div class="tt-collapse-block">
                            <div class="tt-item active" id="showreviews">
                                <div class="tt-collapse-title">
                                    {{ strtoupper(__('webMessage.reviews')) }}({{ count($ReviewsLists) }})</div>
                                <div class="tt-collapse-content">
                                        ...
                                        @if (!empty($ReviewsLists) && count($ReviewsLists) > 0)
                                            <div class="tt-review-comments">
                                                ...
                                                @foreach ($ReviewsLists as $ReviewsList)
                                                    ...
                                                    <div class="tt-item" itemprop="review"
                                                        itemtype="http://schema.org/Review" itemscope>
                                                        <div class="tt-avatar">
                                                            @if (!empty($customerDetails) && $customerDetails->image)
                                                                <a href="javascript:;"><img
                                                                        src="{{ url('uploads/customers/thumb/' . $customerDetails->image) }}"
                                                                        alt=""></a>
                                                            @else
                                                                <a href="javascript:;"><img
                                                                        src="{{ url('assets/images/product/single/review-comments-img-01.jpg') }}"
                                                                        alt=""></a>
                                                            @endif
                                                        </div>
                                                        <div class="tt-content">
                                                            <div class="tt-rating" itemprop="reviewRating"
                                                                itemtype="http://schema.org/Rating" itemscope>
                                                                @if (!empty($reviewRatings))
                                                                    {!! $reviewRatings !!}
                                                                @endif
                                                                <meta itemprop="ratingValue"
                                                                    content="{{ $ReviewsList->ratings }}" />
                                                                <meta itemprop="bestRating" content="5" />
                                                            </div>
                                                            <div class="tt-comments-info" itemprop="author"
                                                                itemtype="http://schema.org/Person" itemscope>
                                                                <span class="username" itemprop="name"
                                                                    content="{{ $ReviewsList->name }}">{{ __('webMessage.by') }}
                                                                    <span>{{ $ReviewsList->name }}</span></span>
                                                                <span
                                                                    class="time">{{ __('webMessage.on') }}
                                                                    {{ \Carbon\Carbon::parse($ReviewsList->created_at)->diffForHumans() }}</span>
                                                            </div>
                                    ...
                                    <div class="tt-review-form">
                                        @if (count($ReviewsLists) == 0)
                                            <div class="tt-message-info">
                                                {{ __('webMessage.bethefirstreview') }}
                                                <strong><span>“{{ $text }}”</span></strong>
                                            </div>
                                        @endif
                                        <p>{{ __('webMessage.reviewnote') }}</p>
                                        <br>
                                        <form class="form-default" name="reviewform" id="reviewform" method="post"
                                            action="{{ url('details/' . request()->id . '/' . request()->slug) }}">
                                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                            <input type="hidden" name="product_id"
                                                value="{{ $productDetails->id }}">
                                            <div class="form-group">
                                                <label for="ratings"
                                                    class="control-label">{{ __('webMessage.ratings') }} *</label>
                                                <select name="ratings" id="ratings" class="form-default">
                                                    <option value="5"
                                                        @if (old('ratings') == '5') selected @endif>
                                                        {{ __('webMessage.superexcellent') }}</option>
                                                    <option value="4.5"
                                                        @if (old('ratings') == '4.5') selected @endif>
                                                        {{ __('webMessage.excellent') }}</option>
                                                    <option value="4"
                                                        @if (old('ratings') == '4') selected @endif>
                                                        {{ __('webMessage.verygood') }}</option>
                                                    <option value="3.5"
                                                        @if (old('ratings') == '3.5') selected @endif>
                                                        {{ __('webMessage.good') }}</option>
                                                    <option value="3"
                                                        @if (old('ratings') == '3') selected @endif>
                                                        {{ __('webMessage.poor') }}</option>
                                                    <option value="2.5"
                                                        @if (old('ratings') == '2.5') selected @endif>
                                                        {{ __('webMessage.verypoor') }}</option>
                                                    <option value="2"
                                                        @if (old('ratings') == '2') selected @endif>
                                                        {{ __('webMessage.notbad') }}</option>
                                                    <option value="1.5"
                                                        @if (old('ratings') == '1.5') selected @endif>
                                                        {{ __('webMessage.bad') }}</option>
                                                    <option value="1"
                                                        @if (old('ratings') == '1') selected @endif>
                                                        {{ __('webMessage.verybad') }}</option>
                                                </select>
                                                @if ($errors->has('ratings'))
                                                    <label id="ratings-error" class="error"
                                                        for="ratings">{{ $errors->first('ratings') }}</label>
                                                @endif
                                            </div>
                                            <div class="form-group">
                                                <label for="name"
                                                    class="control-label">{{ __('webMessage.name') }}
                                                    *</label>
                                            ...
                                            <div class="form-group">
                                                <label for="message"
                                                    class="control-label">{{ __('webMessage.yourreview') }}
                                                    *</label>
                                                <textarea class="form-control" id="message" name="message" placeholder="{{ __('webMessage.writeyourreview') }}"
                                                    rows="8"></textarea>
                                                @if ($errors->has('message'))
                                                    <label id="message-error" class="error"
                                                        for="message">{{ $errors->first('message') }}</label>
                                                @endif
                                            </div>
                                            <div class="form-group">
                                                <div class="g-recaptcha"
                                                    data-sitekey="6LeMueQUAAAAAJ-ZUe9ZqGK3pma9VwbeoaYDgJte"></div>
                                                @if ($errors->has('recaptchaError'))
                                                    <label id="message-error" class="error"
                                                        for="message">{{ $errors->first('recaptchaError') }}</label>
                                                @endif
                                            </div>
                                            <div class="form-group">
                                                <button type="submit"
                                                    class="btn">{{ __('webMessage.sendnow') }}</button>
                                            </div>
                ...
                <div
                    ...
                    @foreach ($relatedProducts as $relatedProduct)
                        @php
                            ...
                            $checkRelatedBrandDiscount = App\Http\Controllers\webController::checkBrandDiscount($relatedProduct->brand_id);
                            $relatedBrandDiscountedPrice = App\Http\Controllers\webController::calByBrandDiscount($relatedProduct->brand_id, $relatedProduct->retail_price);
                        @endphp
                        <div class="col-2 col-md-4 col-lg-3 d-flex align-item-stretch">
                            <div class="tt-product thumbprod-center">
                                <div class="tt-image-box">
                                    <a href="javascript:;" class="tt-btn-wishlist addtowishlistquick"
                                        data-tooltip="{{ __('webMessage.addtowishlist') }}"
                                        {{ __('webMessage.align') }} id="{{ $relatedProduct->id }}"></a>
                                    <a
                                        href="{{ url(app()->getLocale() . '/directdetails/' . $relatedProduct->id . '/' . $relatedProduct->slug) }}">
                                        <span class="tt-img"><img
                                                src="{{ url('assets/images/loader.svg') }}"
                                                data-src="{{ $imageUrl }}" alt=""></span>
                                        @if ($relatedProduct->rollover_image)
                                            <span class="tt-img-roll-over"><img
                                                    src="{{ url('assets/images/loader.svg') }}"
                                                    data-src="{{ url('uploads/product/' . $relatedProduct->rollover_image) }}"
                                                    alt=""></span>
                                        @endif
                                    </a>
                                </div>
                                <div class="tt-description">
                                    ...
                                    <h2 class="tt-title"><a
                                            ...
                                            @else
                                                {{ $relatedProduct->title_ar }}
                                            @endif
                                        </a>
                                    </h2>
                                    <div class="tt-price">
                                        @if (!empty($relatedProduct->countdown_datetime) && strtotime($relatedProduct->countdown_datetime) > strtotime(date('Y-m-d')))
                                            <span class="new-price">{{ $relatedProduct->countdown_price }}
                                                {{ __('webMessage.kd') }}</span>
                                        @elseif ($checkRelatedBrandDiscount)
                                            <span class="new-price price_red">{{ $relatedBrandDiscountedPrice->price }}
                                                {{ __('webMessage.kd') }}</span>
                                            <input type="hidden" id="pixel_price_{{ $relatedProduct->id }}"
                                                value="{{ $relatedBrandDiscountedPrice->price }}">
                                                @if(!empty($brandDiscountedPrice->oldPrice))
                                            <span
                                                class="old-price price_black">{{ $brandDiscountedPrice->oldPrice }}
                                                {{ __('webMessage.kd') }}</span>
                                                @endif
                                        @else
                                            <span class="new-price">{{ $relatedProduct->retail_price }}
                                                {{ __('webMessage.kd') }}</span>
                                            @if (!empty($relatedProduct->old_price))
                                                <span class="old-price">{{ $relatedProduct->old_price }}
                                                    {{ __('webMessage.kd') }}</span>
                                            @endif
                                        @endif
                                        @if (!empty($tagsDetails))
                                            <div class="pro_tags"> {!! $tagsDetails !!}</div>
                                        @endif
                                    </div>
                                    <div class="tt-product-inside-hover">
                                        <div class="tt-row-btn">
                                            @if ($relatedProduct->is_attribute)
                                                <a href="{{ url(app()->getLocale() . '/directdetails/' . $relatedProduct->id . '/' . $relatedProduct->slug) }}"
                                                    class="tt-btn-addtocart thumbprod-button-bg"
                                                    id="{{ $relatedProduct->id }}">{{ __('webMessage.details') }}</a>
                                            @else
                                                @if (!empty($isStock))
                                                    @if ($relatedProduct->is_active == '2')
                                                        <a href="javascript:;"
                                                            class="tt-btn-addtocart thumbprod-button-bg addtocartsingle"
                                                            id="{{ $relatedProduct->id }}">{{ __('webMessage.preorder') }}</a>
                                                    @else
                                                        <a href="javascript:;"
                                                            class="tt-btn-addtocart thumbprod-button-bg addtocartsingle"
                                                            id="{{ $relatedProduct->id }}">{{ __('webMessage.addtocart_btn') }}</a>
                                                    @endif
                                                @endif
                                            @endif
                                        </div>
                                        <div class="tt-row-btn">
                                            <a href="javascript:;" class="tt-btn-quickview loadquickviewmodal"
                                                id="{{ $relatedProduct->id }}"></a>
                                            <a href="javascript:;" class="tt-btn-wishlist addtowishlistquick"
                                                id="{{ $relatedProduct->id }}"></a>
                                        </div>
                                    </div>
