...
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    ...
    <meta property="og:url" content="{{url('directdetails/'.$productDetails->id.'/'.$productDetails->slug.'/'.$strLang)}}">
    @endif
					...
					<div class="tt-product-single-info">
						...
						<div class="tt-add-info">
							<ul> 
                                ...
                                @if(!empty($brandDetails['title_'.$strLang]))
                                <li itemprop="brand" itemtype="http://schema.org/Brand" itemscope><span>{{__('webMessage.brand')}}:</span> <a href="{{url('brands/'.$brandDetails->slug)}}">@if(!empty($brandDetails->image)) <img style="max-height:100px;max-width:100px;" src="{{url('uploads/brand/thumb/'.$brandDetails->image)}}"> @else {{$brandDetails['title_'.$strLang]}} @endif</a>
                        ...
                        <span  class="old-price price_black"  id="oldprices"><small><span id="">{{round($productDetails->retail_price,3)}}</span>{{__('webMessage.kd')}}</small></span>
                           ...
                           <div itemprop="offers" itemtype="http://schema.org/Offer" itemscope>
                                <link itemprop="url" href="{{url('directdetails/'.$productDetails->id.'/'.$productDetails->slug.'/'.$strLang)}}" />
                        ...
                        @else
							<span class="@if($productDetails->old_price) price_red @endif new-price"><span id="display_price">{{round($productDetails->retail_price,3)}}</span>{{__('webMessage.kd')}}</span>
                        ...
                        @endif
                         <div class="col-6">
                           ...
                           $url   = url('details/'.$productDetails->id.'/'.$productDetails->slug);
                           ...
                           @endphp
                            <ul class="tt-social-icon">
                                ...
                                <li><a class="icon-h-12" target="_blank" href="{{$whatsapp_Share}}"></a></li>
                            </ul>
                           </div>
                           </div> 
						</div>
				...
				<div class="col-2 col-md-4 col-lg-3">
					<div class="tt-product thumbprod-center">
						<div class="tt-image-box">
							...
							<a href="{{url('directdetails/'.$relatedProduct->id.'/'.$relatedProduct->slug.'/'.$strLang)}}">
						...
						<div class="tt-description">
							...
							<h2 class="tt-title"><a href="{{url('directdetails/'.$relatedProduct->id.'/'.$relatedProduct->slug.'/'.$strLang)}}">@if(app()->getLocale()=="en") {{$relatedProduct->title_en}} @else {{$relatedProduct->title_ar}} @endif</a></h2>
							<div class="tt-price">
							...
							<div class="tt-product-inside-hover">
								<div class="tt-row-btn">
                                    ...
                                    <a href="{{url('directdetails/'.$relatedProduct->id.'/'.$relatedProduct->slug.'/'.$strLang)}}" class="tt-btn-addtocart thumbprod-button-bg" id="{{$relatedProduct->id}}">{{__('webMessage.details')}}</a>
                                    @else
                                    @if(!empty($isStock))
