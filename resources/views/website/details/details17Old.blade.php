...
<head>
    ...
    <title>
        ...
        @elseif(app()->getLocale() == 'ar' && !empty($settingInfo->name_ar))
            {{ $settingInfo->name_ar }}
        @endif | @if (app()->getLocale() == 'en' && !empty($productDetails->title_en)) {{ $productDetails->title_en }} @elseif(app()->getLocale() == 'ar' && !empty($productDetails->title_ar)) {{ $productDetails->title_ar }} @endif
    </title>
        ...
        <div class="container">
            <ul itemscope itemtype="https://schema.org/BreadcrumbList">
                ...
                <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"><a
                        href="javascript:;"><span itemprop="name">@if (app()->getLocale() == 'en') {{ $productDetails->title_en }} @else {{ $productDetails->title_ar }} @endif</span></a>
                                            ...
                                            @foreach ($productoptions as $productoption)
                                                ...
                                                @else
                                                    ...
                                                    @if (!empty($customOptions['CustomOptionName']) && $customOptions['CustomOptionType'] == 'radio')
                                                        <div class="tt-wrapper">
                                                            <div class="tt-title-options">
                                                                ...
                                                                @if (!empty($productoption->is_required))*@endif:</div>
                                                    ...
                                                    @if (!empty($customOptions['CustomOptionName']) && $customOptions['CustomOptionType'] == 'checkbox')
                                                        <div class="tt-wrapper">
                                                            <div class="tt-title-options">
                                                                {{ $customOptions['CustomOptionName'] }}@if (!empty($productoption->is_required))*@endif:
                                                            </div>
                                                            <ul class="optionradio">
                                                                @if (!empty($customOptions['childs']) && count($customOptions['childs']) > 0)
                                                                    @php $is_cadd_txt=''; @endphp
                                ...
                                <div class="tt-collapse-block">
                                    <div class="tt-item active">
                                        ...
                                        <div class="tt-collapse-content">
                                            {{ str_limit(strip_tags(html_entity_decode(preg_replace('/\s\s+/',' ',app()->getLocale() == 'en' ? $productDetails->details_en : $productDetails->details_ar))),300) }}
                                        </div>
                                    </div>
                                    <div class="tt-item">
                                        ...
                                        <form class="form-default" name="reviewform" id="reviewform" method="post"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="ratings" id="ratings" class="form-default">
                                                    <option value="5" @if (old('ratings') == '5') selected @endif>
                                                        {{ __('webMessage.superexcellent') }}</option>
                                                    <option value="4.5" @if (old('ratings') == '4.5') selected @endif>
                                                        {{ __('webMessage.excellent') }}</option>
                                                    <option value="4" @if (old('ratings') == '4') selected @endif>
                                                        {{ __('webMessage.verygood') }}</option>
                                                    <option value="3.5" @if (old('ratings') == '3.5') selected @endif>
                                                        {{ __('webMessage.good') }}</option>
                                                    <option value="3" @if (old('ratings') == '3') selected @endif>
                                                        {{ __('webMessage.poor') }}</option>
                                                    <option value="2.5" @if (old('ratings') == '2.5') selected @endif>
                                                        {{ __('webMessage.verypoor') }}</option>
                                                    <option value="2" @if (old('ratings') == '2') selected @endif>
                                                        {{ __('webMessage.notbad') }}</option>
                                                    <option value="1.5" @if (old('ratings') == '1.5') selected @endif>
                                                        {{ __('webMessage.bad') }}</option>
                                                    <option value="1" @if (old('ratings') == '1') selected @endif>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="message" name="message"
                                                    placeholder="{{ __('webMessage.writeyourreview') }}"
                                                    rows="8"></textarea>
                        ...
                        <div class="col-2 col-md-4 col-lg-3 d-flex align-item-stretch">
                            <div class="tt-product thumbprod-center">
                                ...
                                <div class="tt-description">
                                    ...
                                    <h2 class="tt-title"><a
                                            href="{{ url(app()->getLocale() . '/directdetails/' . $relatedProduct->id . '/' . $relatedProduct->slug) }}">@if (app()->getLocale() == 'en') {{ $relatedProduct->title_en }} @else {{ $relatedProduct->title_ar }} @endif</a>
                                    </h2>
                                    <div class="tt-price">
