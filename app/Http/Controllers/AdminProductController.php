		...
		try {
			...
			if ($request->hasfile('image')) {
				...
				if ($request->image->getClientOriginalExtension() == 'gif') {
					...
					copy(public_path() . '/' . 'uploads/product/original/' . $imageName, public_path() . '/' . 'uploads/product/' . $imageName);
				} else {
			...
			if ($request->hasfile('rollover_image')) {
				...
				if ($request->rollover_image->getClientOriginalExtension() == 'gif') {
					$request->rollover_image->move(public_path('uploads/product/original'), $imageName_roll);
					copy(public_path() . '/' . 'uploads/product/original/' . $imageName_roll, public_path() . '/' . 'uploads/product/' . $imageName_roll);
				} else {
			...
			if (!empty($id) && !empty($request->file('attach')) && count($request->file('attach')) > 0) {
				...
				foreach ($request->file('attach') as $key => $file) {
					...
					if ($file['attach_file']) {
						...
						if ($file['attach_file']->getClientOriginalExtension() == 'gif') {
